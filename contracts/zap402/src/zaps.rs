//! Zap (Layer 1) record storage and transfer logic for the Zap402 contract.
//!
//! Individual zap records use temporary storage so they expire after a bounded
//! lifetime, while aggregate counters remain in persistent contract state.
...
pub fn send_tip(
    ...
    network::update_network(env, &profile);
