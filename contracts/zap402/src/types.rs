//! Data types for the Zap402 contract.
...
/// Network ranking entry for top creators (by lifetime tips received).
#[contracttype]
#[derive(Clone, Debug)]
...
pub struct ContractConfig {
    ...
    pub fee_bps: u32,
    /// Tip / withdrawal asset Stellar Asset Contract (SAC) — USDC SAC, native XLM SAC, etc.
