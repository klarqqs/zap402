//! Fee calculation helper for the Zap402 contract.
//!
...
mod tests {
    ...
    #[test]
    fn fee_minimum_one_stroop_when_bps_positive() {
        // 200 bps of 49 stroops truncates to 0, but fee_bps > 0 ⇒ min 1 stroop (see module docs).
