...
Complete guide to setting up Zap402 for local development.
...
Save the returned **Contract ID** (starts with `C`) — set it as **`VITE_CONTRACT_ID`** in `frontend-scaffold/.env`.
