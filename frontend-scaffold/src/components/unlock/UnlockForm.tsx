        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
          {CONTENT_TYPES.map((t) => (
            <button
              ...
              className={`border p-3 text-left transition-colors ${contentType === t.value
                  ? "border-zap-accent bg-zap-accent-dim/30"
                  : "border-zap-bg-alt bg-zap-bg-alt hover:border-zap-bg-alt-bright"
                }`}
            >
              <p
                className={`font-body text-[16px] uppercase tracking-[0.12em] ${contentType === t.value ? "text-zap-accent" : "text-zap-ink-muted"
                  }`}
              >
                {t.label}
              </p>
